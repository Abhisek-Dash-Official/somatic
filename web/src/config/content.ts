export const pageContent = {
  ...
  blog: [
    {
      id: 1,
      title: "How AI Can Assist Ayush Healthcare Professionals",
      date: "Aug 20, 2026",
      excerpt:
        "Discover how responsible AI assistance can help organize patient information, support clinical documentation, and make digital healthcare workflows more efficient while keeping doctors in control.",
    },
    {
      id: 2,
      title: "Streamlining Ayush Consultations with Digital Case Taking",
      date: "Aug 15, 2026",
      excerpt:
    ...
    {
      id: 3,
      title: "The Role of AI in Structured Patient Case Taking",
      date: "Aug 10, 2026",
      excerpt:
        "Explore how AI can organize patient-provided information and generate preliminary clinical drafts that can be reviewed and refined by healthcare professionals.",
    },
    {
      id: 4,
      title: "Bridging Ancient Wisdom & Modern Tech: Dual-Modality AI Triage",
      date: "Aug 25, 2026",
      category: "AI & Innovation",
      readTime: "5 min read",
      excerpt:
        "Discover how Somatic seamlessly integrates standard Allopathic symptom extraction with real-time Ayurvedic Dosha (Vata-Pitta-Kapha) algorithms to provide a holistic clinical starting point.",
    },
    {
      id: 5,
      title:
        "Minutes Matter: How Automated SOS Flagging Transforms Waiting Rooms",
      date: "Aug 20, 2026",
      category: "Clinical Workflow",
      readTime: "4 min read",
      excerpt:
        "Not all patients in the digital queue can wait. Learn how our AI engine detects critical keywords to automatically flag emergencies and route severe cases to specialists instantly.",
    },
    {
      id: 6,
      title:
        "Zero-Trust Healthcare: Securing Patient Data with Immutable Audit Logs",
      date: "Aug 15, 2026",
      category: "Data Security",
      readTime: "6 min read",
      excerpt:
        "In an era of digital breaches, patient privacy is non-negotiable. Explore how Somatic enforces Role-Based Access Control (RBAC) and strict MongoDB audit trails for absolute accountability.",
    },
    {
      id: 7,
      title: "Curing Doctor Burnout with 1-Click Digital Prescriptions",
      date: "Aug 10, 2026",
      category: "Practitioner Success",
      readTime: "3 min read",
      excerpt:
        "Manual paperwork is overwhelming our clinics. See how pre-filled AI drafts, smart queue management, and automated prescriptions are reducing documentation time by up to 70%.",
    },
    {
      id: 8,
      title: "Breaking Barriers: Voice-Driven Triage and Multilingual Care",
      date: "Aug 02, 2026",
      category: "Accessibility",
      readTime: "4 min read",
      excerpt:
        "Healthcare should be accessible to everyone. Find out how integrating the Web Speech API allows patients to dictate symptoms naturally, generating clinical notes in their preferred language.",
    },
    {
      id: 9,
      title: "Ensuring 99.9% Uptime in Critical Care Telemedicine",
      date: "Jul 28, 2026",
      category: "Engineering",
      readTime: "5 min read",
      excerpt:
        "A deep dive into our infrastructure. Learn why we implemented Upstash Redis sliding-window rate limiting to protect our healthcare APIs from abuse and guarantee high availability.",
    },
  ],
  features: [
    {
